...
namespace Splitit.SDK.Example
{
    ...
    class PaymentFormIFrame
    {
        ...
        {
            // Initiates the plan with isOpenedInIframe flag set to true
            ...
            var initResponse = PlanApi.InstallmentPlanInitiate(new InitiateInstallmentPlanRequest()
            {
                ...
                PaymentWizardData = new PaymentWizardData(isOpenedInIframe: true, requestedNumberOfInstallments: "1,2,3,4,5,6"),
